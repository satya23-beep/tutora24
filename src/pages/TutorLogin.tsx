      ...
      <div className="container mx-auto px-4 max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-black text-gray-900 mb-2">Tutor Login</h1>
            <p className="text-gray-600">Access your tutor dashboard and manage sessions</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 text-center">
            <p className="text-gray-600 text-sm mb-3">Not a tutor yet?</p>
            <a
              href="/register"
